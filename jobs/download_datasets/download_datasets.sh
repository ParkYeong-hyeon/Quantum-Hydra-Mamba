...
#SBATCH -D /scratch/connectome/mandy/projects/quantum_hydra_mamba/Quantum-Hydra-Mamba
...
echo "Command: $PYTHON_CMD scripts/mandy_download_all_datasets.py "
echo ""

$PYTHON_CMD scripts/mandy_download_all_datasets.py 
