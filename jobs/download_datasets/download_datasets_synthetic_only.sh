...
echo "Command: python scripts/mandy_download_all_datasets.py --skip-dna --skip-genomic --skip-physionet"
echo ""

$PYTHON_CMD scripts/mandy_download_all_datasets.py --skip-dna --skip-genomic --skip-physionet
