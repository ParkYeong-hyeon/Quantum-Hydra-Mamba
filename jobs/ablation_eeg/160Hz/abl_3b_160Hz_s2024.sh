#!/bin/bash
#SBATCH --job-name=abl_3b_160Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_3b_160Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_3b_160Hz_s2024.log

# ============================================
# Ablation Study Job [94/108]
# ============================================
...
echo "============================================"
echo "Job: abl_3b_160Hz_s2024"
echo "Model: 3b (TrueClassicalMamba)"
