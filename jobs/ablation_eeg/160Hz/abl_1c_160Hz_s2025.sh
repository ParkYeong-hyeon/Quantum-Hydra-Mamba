#!/bin/bash
#SBATCH --job-name=abl_1c_160Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_1c_160Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_1c_160Hz_s2025.log

# ============================================
# Ablation Study Job [80/108]
# ============================================
