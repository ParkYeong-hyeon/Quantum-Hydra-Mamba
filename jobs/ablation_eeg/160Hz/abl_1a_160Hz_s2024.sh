#!/bin/bash
#SBATCH --job-name=abl_1a_160Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_1a_160Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_1a_160Hz_s2024.log

# ============================================
# Ablation Study Job [73/108]
# ============================================
