#!/bin/bash
#SBATCH --job-name=abl_4b_160Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4b_160Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4b_160Hz_s2024.log

# ============================================
# Ablation Study Job [103/108]
# ============================================
# Model: 4b (QuantumMambaE2E)
...
echo "============================================"
echo "Job: abl_4b_160Hz_s2024"
echo "Model: 4b (QuantumMambaE2E)"
