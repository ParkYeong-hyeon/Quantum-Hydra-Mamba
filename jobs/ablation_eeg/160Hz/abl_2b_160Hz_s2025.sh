#!/bin/bash
#SBATCH --job-name=abl_2b_160Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_2b_160Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_2b_160Hz_s2025.log

# ============================================
# Ablation Study Job [86/108]
# ============================================
# Model: 2b (ClassicalMambaQuantumSSM)
...
echo "============================================"
echo "Job: abl_2b_160Hz_s2025"
echo "Model: 2b (ClassicalMambaQuantumSSM)"
