#!/bin/bash
#SBATCH --job-name=abl_4c_160Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4c_160Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4c_160Hz_s2025.log

# ============================================
# Ablation Study Job [107/108]
# ============================================
# Model: 4c (QuantumHydraE2E)
...
echo "============================================"
echo "Job: abl_4c_160Hz_s2025"
echo "Model: 4c (QuantumHydraE2E)"
