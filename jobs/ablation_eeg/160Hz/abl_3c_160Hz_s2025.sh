#!/bin/bash
#SBATCH --job-name=abl_3c_160Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_3c_160Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_3c_160Hz_s2025.log

# ============================================
# Ablation Study Job [98/108]
# ============================================
...
echo "============================================"
echo "Job: abl_3c_160Hz_s2025"
echo "Model: 3c (TrueClassicalHydra)"
