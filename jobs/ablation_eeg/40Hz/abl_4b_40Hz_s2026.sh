#!/bin/bash
#SBATCH --job-name=abl_4b_40Hz_s2026
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4b_40Hz_s2026.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4b_40Hz_s2026.log

# ============================================
# Ablation Study Job [33/108]
# ============================================
