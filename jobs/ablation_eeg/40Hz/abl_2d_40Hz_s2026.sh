#!/bin/bash
#SBATCH --job-name=abl_2d_40Hz_s2026
...
#SBATCH --output=/pscratch/sd/j/junghoon/quantum_hydra_mamba/results/ablation_eeg/logs/abl_2d_40Hz_s2026.log
#SBATCH --error=/pscratch/sd/j/junghoon/quantum_hydra_mamba/results/ablation_eeg/logs/abl_2d_40Hz_s2026.log
