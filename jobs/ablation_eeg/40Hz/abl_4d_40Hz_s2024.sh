#!/bin/bash
#SBATCH --job-name=abl_4d_40Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4d_40Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4d_40Hz_s2024.log
