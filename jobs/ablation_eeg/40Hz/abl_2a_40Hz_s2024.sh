#!/bin/bash
#SBATCH --job-name=abl_2a_40Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_2a_40Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_2a_40Hz_s2024.log

# ============================================
# Ablation Study Job [10/108]
# ============================================
