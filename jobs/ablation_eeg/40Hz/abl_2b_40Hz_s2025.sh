#!/bin/bash
#SBATCH --job-name=abl_2b_40Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_2b_40Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_2b_40Hz_s2025.log

# ============================================
# Ablation Study Job [14/108]
# ============================================
