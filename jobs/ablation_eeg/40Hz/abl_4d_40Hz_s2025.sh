#!/bin/bash
#SBATCH --job-name=abl_4d_40Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4d_40Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4d_40Hz_s2025.log
