#!/bin/bash
#SBATCH --job-name=abl_3c_40Hz_s2026
...
#SBATCH --output=./results/ablation_eeg/logs/abl_3c_40Hz_s2026.log
#SBATCH --error=./results/ablation_eeg/logs/abl_3c_40Hz_s2026.log

# ============================================
# Ablation Study Job [27/108]
# ============================================
