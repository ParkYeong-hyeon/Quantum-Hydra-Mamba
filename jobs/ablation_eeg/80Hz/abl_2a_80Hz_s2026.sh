#!/bin/bash
#SBATCH --job-name=abl_2a_80Hz_s2026
...
#SBATCH --output=./results/ablation_eeg/logs/abl_2a_80Hz_s2026.log
#SBATCH --error=./results/ablation_eeg/logs/abl_2a_80Hz_s2026.log

# ============================================
# Ablation Study Job [48/108]
# ============================================
