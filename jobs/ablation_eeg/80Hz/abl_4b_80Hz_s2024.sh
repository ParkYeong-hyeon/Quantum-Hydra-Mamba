#!/bin/bash
#SBATCH --job-name=abl_4b_80Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4b_80Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4b_80Hz_s2024.log

# ============================================
# Ablation Study Job [67/108]
# ============================================
