#!/bin/bash
#SBATCH --job-name=abl_2c_80Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_2c_80Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_2c_80Hz_s2025.log

# ============================================
# Ablation Study Job [53/108]
# ============================================
