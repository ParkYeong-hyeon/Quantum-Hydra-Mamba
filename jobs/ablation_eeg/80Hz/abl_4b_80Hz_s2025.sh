#!/bin/bash
#SBATCH --job-name=abl_4b_80Hz_s2025
...
#SBATCH --output=./results/ablation_eeg/logs/abl_4b_80Hz_s2025.log
#SBATCH --error=./results/ablation_eeg/logs/abl_4b_80Hz_s2025.log

# ============================================
# Ablation Study Job [68/108]
# ============================================
