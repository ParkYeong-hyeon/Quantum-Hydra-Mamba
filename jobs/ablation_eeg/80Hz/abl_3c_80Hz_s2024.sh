#!/bin/bash
#SBATCH --job-name=abl_3c_80Hz_s2024
...
#SBATCH --output=./results/ablation_eeg/logs/abl_3c_80Hz_s2024.log
#SBATCH --error=./results/ablation_eeg/logs/abl_3c_80Hz_s2024.log

# ============================================
# Ablation Study Job [61/108]
# ============================================
