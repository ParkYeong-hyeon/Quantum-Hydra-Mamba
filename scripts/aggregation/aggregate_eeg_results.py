#!/usr/bin/env python3
"""
Aggregate EEG Classification Results Across All Seeds
...
# Configuration
RESULTS_DIR = Path("./experiments/eeg_results")
MODELS = [
    'quantum_hydra',
...
def aggregate_metrics():
    ...
    print("="*80)
    print("Aggregating EEG Classification Results")
    print("="*80)
...
def save_summary_table(aggregated_data):
    ...
    # Save to CSV
    csv_file = RESULTS_DIR / "eeg_aggregated_results.csv"
    df_sorted.to_csv(csv_file, index=False)
    print(f"CSV saved to: {csv_file}")

    # Save to LaTeX
    latex_file = RESULTS_DIR / "eeg_aggregated_results.tex"
...
def plot_comparison(aggregated_data):
    ...
    plt.tight_layout()
    plot_file = RESULTS_DIR / "eeg_comparison_plots.pdf"
...
def main():
    ...
    print("\n" + "="*80)
    print("EEG CLASSIFICATION RESULTS AGGREGATION")
    print("="*80)
    ...
    print("="*80)
    print(f"CSV: {RESULTS_DIR}/eeg_aggregated_results.csv")
    print(f"LaTeX: {RESULTS_DIR}/eeg_aggregated_results.tex")
    print(f"Plots: {RESULTS_DIR}/eeg_comparison_plots.pdf")
    print("="*80 + "\n")
