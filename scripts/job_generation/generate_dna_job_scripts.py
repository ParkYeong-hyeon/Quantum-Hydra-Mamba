...
# Run training
python scripts/training/run_single_model_dna.py \\
...
"""
    ...
    for i, job_file in enumerate(job_files, 1):
        ...
        master_script += f"sbatch job_scripts/dna/{job_file}\n"
...
"""
    ...
    print(f"   bash job_scripts/dna/dna_quantum_hydra_seed2024.sh")
    print()
