#!/usr/bin/env python3
"""
Single Model Training Script for EEG Classification
...
# Import all 8 models (including Lite variants)
...
from models.QuantumMambaLite import QuantumMambaTS_Lite
from models.QuantumMambaHybridLite import QuantumMambaHybridTS_Lite
...
def train_epoch(model, train_loader, criterion, optimizer, device):
    ...
    for batch_x, batch_y in train_loader:
        ...
        loss.backward()
        # Gradient clipping to prevent NaN issues (especially for classical_hydra on EEG)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train a single model on EEG Motor Imagery classification"
    )
    ...
    parser.add_argument("--output-dir", type=str, default="./results/eeg_results",
    ...
    print("\n" + "="*80)
    print("EEG MOTOR IMAGERY CLASSIFICATION - SINGLE MODEL TRAINING")
    print("="*80)
